...
- **Catégorie Vinted cible : `157`**, « Sacs à dos » sous **Femmes > Sacs**. Fil d'Ariane attendu : `Femmes > Sacs`. Ne jamais utiliser `246` (Hommes), qui apparaît dans le relevé du 2026-09-08 par erreur de navigation.

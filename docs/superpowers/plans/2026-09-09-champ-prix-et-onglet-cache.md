...
- **Aucun sélecteur n'est inventé.** `[data-testid="price-input"]` (le conteneur) et `[data-testid="price-input--input"]` (le champ) sont les seuls admis, et viennent des relevés de `docs/audits/`.
